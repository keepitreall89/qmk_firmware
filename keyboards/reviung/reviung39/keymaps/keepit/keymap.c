...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung39(
    ...
    KC_LSFT, KC_NO,	  LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO,      		KC_NO,   KC_NO,	  KC_NO,   KC_NO,	KC_NO,	KC_NO,
  ...
  [_RAISE] = LAYOUT_reviung39(
    ...
    OSM(MOD_LCTL),  OSM(MOD_LALT),  OSM(MOD_LGUI),  KC_NO,  KC_NO, KC_NO,      KC_PEQL, KC_PDOT, KC_P0,   KC_P1, KC_P2, KC_P3,
